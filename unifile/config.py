...
QScrollBar:vertical {{ background: transparent; width: 10px; border: none; margin: 6px 0; }}
...
QScrollBar:horizontal {{ background: transparent; height: 10px; border: none; margin: 0 6px; }}
